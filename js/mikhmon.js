function RequiredV() {
    var e = document.getElementById("expmode").value, t = document.getElementById("validity").style,
        n = document.getElementById("validi");
    "rem" === e || "remc" === e ? (t.display = "table-row", n.type = "text", "" === n.value && (n.value = ""), $("#validi").focus()) : "ntf" === e || "ntfc" === e ? (t.display = "table-row", n.type = "text", "" === n.value && (n.value = ""), $("#validi").focus()) : (t.display = "none", n.type = "hidden")
}

function defUserl() {
    var e = document.getElementById("user").value, t = document.getElementById("num").style,
        n = document.getElementById("lower").style, l = document.getElementById("upper").style,
        o = document.getElementById("upplow").style, i = document.getElementById("lower1").style,
        d = document.getElementById("upper1").style, a = document.getElementById("upplow1").style,
        c = document.getElementById("mix").style, m = document.getElementById("mix1").style,
        s = document.getElementById("mix2").style;
    "up" === e ? ($("select[name=userl] option:first").html("4"), $("select[name=char] option:first").html("Random abcd"), n.display = "block", l.display = "block", o.display = "block", i.display = "none", d.display = "none", a.display = "none", t.display = "none", c.display = "block", m.display = "block", s.display = "block") : "vc" === e && ($("select[name=userl] option:first").html("8"), $("select[name=char] option:first").html("Random abcd2345"), n.display = "none", l.display = "none", o.display = "none", i.display = "block", d.display = "block", a.display = "block", t.display = "block", c.display = "block", m.display = "block", s.display = "block")
}
...
function makeSortable(e) {
    var t, n = e.tHead;
    if (n && (n = n.rows[0]) && (n = n.cells), n) for (t = n.length; --t >= 0;) !function (t) {
        var l = 1;
...
function startTimer() {
    var e = document.getElementById("logout"), t = document.getElementById("timer"), n = t.innerHTML.split(/[:]+/),
        l = n[0], o = checkSecond(n[1] - 1);
...
var url = window.location.href, getID = url.split("=")[1];
